...
def plot_channel_histogram(ch, time, channel_start, channel_stop, fit_function = None, param_names = None , param_units = None, p0 = None,  bounds = (-numpy.inf, numpy.inf), save_fig = False, range_hist = None, x_min = 0.):
...
if __name__ == '__main__' :   
    ...
    #fit 14 13 insieme con doppia exp    
    ...
    plot_functions.fit_histogram(bins, n, dn, param_names, param_units, fit_function = functions.two_expo, p0 = p0, bounds = bounds, x_min = 0.5)    
    ...
    plot_channel_histogram(ch, time, 3, 1 , range_hist = (0., 1000000))
    
    
    plot_channel_histogram(ch, time, 4, 1, range_hist = (0., 3))    
